...
![개인정보 탐지](./assets/개인정보탐지.gif)

**시연 내용:**
- ✅ **EMAIL**: `bo***@kisia.or.kr` (신뢰도: 99.9%)
- ✅ **NAME**: `이**` (신뢰도: 60.6%)
- ✅ **PHONE_NUM**: `0**-***-****` (신뢰도: 99.0%)
- RoBERTa 기반 PII 탐지 엔진이 실시간으로 개인정보를 감지
- 이름, 전화번호, 이메일 등 다양한 개인정보 타입 탐지
- ChatGPT 전송 차단 및 상세 차단 사유 표시

#### 2️⃣ 맥락 탐지 시연

![맥락 탐지](./assets/맥락탐지.gif)

**시연 내용:**
- 정책 위반 탐지 시스템의 실시간 작동
- 개인정보 침해, 기밀 정보 등 맥락 기반 분석
- ChatGPT 프록시를 통한 즉각적인 요청 차단
- 사용자 친화적인 차단 메시지 제공
