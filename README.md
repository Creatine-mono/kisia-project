...
#### 1. ChatGPT 초기 화면
![ChatGPT 초기 화면](./assets/screenshot1.png)

#### 2. 개인정보 탐지 및 차단
![DLP 차단 화면](./assets/screenshot2.png)

**차단 내용:**
- ✅ **EMAIL**: `bo***@kisia.or.kr` (신뢰도: 99.9%)
- ✅ **NAME**: `이**` (신뢰도: 60.6%)
- ✅ **PHONE_NUM**: `0**-***-****` (신뢰도: 99.0%)

시스템이 실시간으로 개인정보를 탐지하고 ChatGPT 전송을 차단한 모습입니다.
...
<details>
<summary><b>개인정보 탐지 시연 (클릭하여 펼치기)</b></summary>

**시연 내용:**
- RoBERTa 기반 PII 탐지 엔진이 실시간으로 개인정보를 감지하는 과정
- 이름, 전화번호, 이메일 등 다양한 개인정보 타입 탐지
- 탐지된 정보의 신뢰도 표시

비디오 파일: `./assets/미디어1.mov`

</details>

<details>
<summary><b>맥락 탐지 시연 (클릭하여 펼치기)</b></summary>

**시연 내용:**
- 정책 위반 탐지 시스템 작동 과정
- 개인정보 침해, 기밀 정보 등 맥락 기반 분석
- ChatGPT 프록시를 통한 실시간 차단

비디오 파일: `./assets/미디어2.mov`

</details>

> **📝 참고:**
> - 스크린샷을 추가하려면 `assets` 폴더에 이미지를 저장하세요
> - 비디오를 추가하려면 바탕화면의 `.mov` 파일을 `assets` 폴더로 복사하세요
